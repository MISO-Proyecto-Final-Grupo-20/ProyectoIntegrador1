...
export let options = {
  stages: [
    { duration: '30s', target: 100 }, // Aumenta carga
    { duration: '4m', target: 200 }, // Mantiene carga
    { duration: '30s', target: 0 }, // Reduce carga
  ],
  thresholds: {
...
export function handleSummary(data) {
  return {
    "resultados_prueba_resiliencia_pedidos_5m.html": htmlReport(data),
  };
}
